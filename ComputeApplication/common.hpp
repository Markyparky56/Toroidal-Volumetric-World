...
static constexpr unsigned int chunkSpawnDistance = 3;
...
static constexpr unsigned int WorldDimension = 256; // In chunks
static constexpr unsigned int WorldDimensionsInVoxels = WorldDimension * TechnicalChunkDim;
static constexpr float heightMapHeightInVoxels = 32.f * 4.f; 
...
static constexpr float chunkDespawnRadius = chunkSpawnRadius * 1.1f;
